# Riverdex Smart Order Router

This repository contains routing logic for the Riverex protocol.

## ***Run test server***
run the command 

```
npm i && npm run build && npm run test_server
```
