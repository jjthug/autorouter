...
import {RiverexRouteRaw} from "./alpha-router/entities/riverex-route";
...
export class RiverexRoute extends RiverexRouteRaw<Token, Token> {
  protocol: Protocol.RIVERDEX = Protocol.RIVERDEX;
}
